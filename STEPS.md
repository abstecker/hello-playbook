...
| 011 | `step-011-test-that-fails` | test_fail | test: greet should ignore stray whitespace (failing) · exercise: Make the test pass | [src/ch04-tests-and-failing-on-purpose.md](https://abstecker.github.io/hello-playbook/ch04-tests-and-failing-on-purpose.html#step-test-that-fails) |
...
| 021 | `step-021-shout` | test_fail | experiment: shout the greeting · on try/shout | [src/ch07-try-it-on-a-branch.md](https://abstecker.github.io/hello-playbook/ch07-try-it-on-a-branch.html#step-shout) |
| 022 | `step-022-greet-many` | pass | feat: greet_all(), one greeting per name · on feat/greet-many | [src/ch07-try-it-on-a-branch.md](https://abstecker.github.io/hello-playbook/ch07-try-it-on-a-branch.html#step-greet-many) |
| 023 | `step-023-greet-many-test` | pass | test: greet_all keeps the order · on feat/greet-many | [src/ch07-try-it-on-a-branch.md](https://abstecker.github.io/hello-playbook/ch07-try-it-on-a-branch.html#step-greet-many-test) |
| 024 | `step-024-changelog` | pass | docs: start a changelog | [src/ch07-try-it-on-a-branch.md](https://abstecker.github.io/hello-playbook/ch07-try-it-on-a-branch.html#step-changelog) |
| 025 | `step-025-merge-greet-many` | pass | merge: feat/greet-many · merges feat/greet-many | [src/ch07-try-it-on-a-branch.md](https://abstecker.github.io/hello-playbook/ch07-try-it-on-a-branch.html#step-merge-greet-many) |
